...
<script>
import TableSchool from "../../../../components/profile/orther/table-school";
...
export default {
  ...
  computed: {
    dataTable() {
      const listData = this.$store.state.profileModule.listSchool;
